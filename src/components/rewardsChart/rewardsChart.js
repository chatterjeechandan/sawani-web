    ...
    datasets: [
      {
        data: [
          0,
          Number(percentage?.orderPurchasePercentage),
          Number(percentage?.weeklyLoginPercentage),
        ],
      ...
      <div className="circlePoints">
        <span className="pointsMainInfo">
          ...
          <p className="equalConversion">
            {t("Equals to")}{" "}
            <span>{Number(percentage?.totalEarnings) / 10}</span> {t("SAR")}
          </p>
        </span>
      ...
      <div className="pointsListings">
        <ul className="pointListUl">
          ...
          <li>
            ...
            <span className="pointsName">{t("Weekly logins & other")}</span>
            <span className="pointsPercent">
              {Number(percentage?.weeklyLoginPercentage)}%
            </span>
          </li>
